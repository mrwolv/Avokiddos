...
const BoxContainer = () => {
  ...
  gsap.fromTo(
   ...
   // Offset the start of this animation by the duration of the previous one
  );
    ...
    <section className='grid md:grid-cols-3 hover:cursor-pointer'>
      ...
      >
        <div>
          ...
          <div
            className={`${
              hover
                ? 'animate-text absolute inset-0 bg-red-400 bg-opacity-70'
                : 'hidden'
            }`}
          >
      ...
      >
        ...
        <div
          className={`${
            hover3
              ? 'new-arrival-animation-text absolute inset-0 bg-red-400 bg-opacity-70'
              : 'hidden'
          }`}
        >
          <div className='absolute text-white top-[40%] left-[34%] flex flex-col gap-1 '>
